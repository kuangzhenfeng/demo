...
static void myThreadPoolTestTask(void *para)
{
...
{
#if 1
    my_thread_pool::MyThreadPool::Instance()->create(3);
    for(int i = 0; i < 10; ++i)
    {
        my_thread_pool::MyThreadPool::Instance()->addTask(std::bind(myThreadPoolTestTask, nullptr));
    }
#else
    MyThreadPool *pMyThreadPool = MyThreadPool::Instance();
